...
1. **Aceite o convite do repositório.** Chegou um convite no email da sua conta GitHub (`agalon-hash`).
   ...
   👉 https://github.com/zxmarketingdigital/contabilidade-zx-control/invitations
...
3. **Conecte o repositório** `zxmarketingdigital/contabilidade-zx-control` dentro do Claude Code.
