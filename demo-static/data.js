// Dados fictícios da DEMO estática da Contabilidade (CD Tech). Porte de
// demo/data.mjs para um global de browser (window.__DEMO__). Carteira realista
// de um escritório de SP. Datas relativas a "agora".

window.__DEMO__ = (function () {
  const TOKEN = "demo-contabil-2026";
  ...
  return { TOKEN, empresas, competencias, prazos, saidas, leads, receitas, custos };
})();
